...
def load_gui(self):
    ...
    self.btn_add.grid(row=s,column=0,padx(25,0),pady(45,10),sticky=W)
    self.btn_update = tk.Button(self.master,width=12,height=2,text='Update',command=lambda: student_func.addToList(self))
    self.btn_update.grid(row=s,column=1,padx(15,0),pady(45,10),sticky=W)
    self.btn_delete = tk.Button(self.master,width=12,height=2,text='Delete',command=lambda: student_func.addToList(self))
    self.btn_delete.grid(row=s,column=2,padx(15,0),pady(45,10),sticky=W)
    self.btn_close = tk.Button(self.master,width=12,height=2,text='Close',command=lambda: student_func.addToList(self))
    self.btn_close.grid(row=s,column=4,columnspan=1,padx(15,0),pady(45,10),sticky=E)
